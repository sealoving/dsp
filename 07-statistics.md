...
>> Frequntist statistics consider a random variable with intrinsic parameters, and analysis unusally aim at finding the maximum likelyhood values. This is equivalent to assuming the value of the parameter has a uniform distribution in the space.  
For Bayesian statistics, a prior distribution is required to serve as a starting point of the analysis, then is modified throughout the analysis. 
